      ...
      <div id="slide-contact">
        <form class="addTaskForm" onsubmit="return false;">
            ...
            <div class="addTaskButtons">
                ...
                <button id="formSubmitButton" type="submit" onclick="createNewTask('${progress}')" class="createButton">Create Task <img class="hookIcon" src="../assets/img/hook_icon.png"></button>
            </div>
        </form>
